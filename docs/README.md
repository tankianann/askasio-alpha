...
- Customer-facing chatbot: milestone 8 public configuration/session APIs complete; authenticated public messaging is next and the widget remains unavailable.
