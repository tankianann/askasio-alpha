...
- Customer-facing chatbot: milestone 5 internal conversation persistence complete; shared execution is next and public chatbot behavior remains unavailable.
