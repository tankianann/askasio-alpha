...
return [
    ...
    'maximum_extracted_characters' => Env::int('INGESTION_MAXIMUM_EXTRACTED_CHARACTERS', 500_000),
    'maximum_chunks_per_document' => Env::int('RAG_MAXIMUM_CHUNKS_PER_DOCUMENT', 256),
    'maximum_pdf_pages' => Env::int('PDF_MAXIMUM_PAGES', 250),
